...
public class firstt extends JPanel{
	static short leftx;
	static short lefty;
	static short rightx;
	static short righty;
...
//							System.out.println("");
					...
					if(!(angle<-10) && !(angle>5) && ((distance<500 && distance>250) || (distance>80 && distance<200))){
						robot.keyRelease(KeyEvent.VK_A);
						robot.keyRelease(KeyEvent.VK_D);
...
//						robot.setAutoDelay(50);
					...
					if(angle<=-10 && angle>-55 && ((distance<500 && distance>250) || (distance>80 && distance<200))){
